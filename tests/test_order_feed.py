...
class TestOrderFeed:
    def test_navigate_from_order_feed_to_personal_account_with_state(self, driver_with_state):
    ...
    def test_navigate_from_order_feed_to_personal_account_without_state(self, driver):
